...
//
//  Sets your land parcel media stream picking from a list in a menu.
//  
//
//  The Radio Staion Name and URLs are stored on a configuration notecard.
//
// The Format of the notecard is as follows
//  A Line with the Radio Station Name,
//  followed by a line with the URL of the Radio Station.
//
...
default
{
    ...
    listen(integer channel, string name, key id, string message)
    {
        ...
        else //Patron Chose a Number
        {
            ...
            llSetParcelMusicURL(llList2String(urlData, GoUrl));
